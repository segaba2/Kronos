...
Notes (personal):
    ...
    - Using SAMPLE_COUNT=3 for averaged predictions; more stable than single-sample output.
"""
...
T = 1.0
TOP_P = 0.9
SAMPLE_COUNT = 3  # increased from 1; average over multiple samples for stability
